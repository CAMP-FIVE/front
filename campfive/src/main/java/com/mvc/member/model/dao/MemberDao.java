...
public class MemberDao {
	...
	public Member findId(Connection connection, String userName, String phone) {
		Member member = null;
		PreparedStatement pstmt = null;
		ResultSet rs = null;
		String query = "SELECT ID FROM MEMBER WHERE NAME=? AND PHONE=? AND STATUS='Y'";
	...
	public Member findPwd(Connection connection, String userName, String userId, String phone) {
		Member member = null;
		PreparedStatement pstmt = null;
		ResultSet rs = null;
		String query = "SELECT PWD FROM MEMBER WHERE NAME=? AND ID=? AND STATUS='Y' AND PHONE=?";
		
		System.out.println(userName + ", " + userId + ", " + phone);
