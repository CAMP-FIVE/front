...
<section>
    <form id="bsEnrollFrm" action="${ pageContext.request.contextPath }/member/enrollBusiness" method="post">
    	<table>
        	<tr>
            	<td colspan="2">
                	<div id="userAgree">
        	...
        	<tr>
				<th>사업자등록번호</th>
                <td>
                	<input type="text" placeholder="(-없이)1234567890" name="businessNo" id="businessNo" maxlength="10" required>
                </td>
            </tr>
        	<tr>
            	<td colspan="2">
