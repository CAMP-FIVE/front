        ...
        <div id="enroll-container">
            <form name="memberEnrollFrm" action="${ pageContext.request.contextPath }/member/enrollBusiness" method="post">
                <table id="enrollUserTbl">
                    ...
                    <tr>
                        <th>전화번호</th>
                        <td><input type="tel" placeholder="(-없이)01012345678" id="phone" name="phone" maxlength="11" required></td>
                    </tr>
                    <tr>
                        <th>닉네임</th>
                    ...
                    <tr>
                        <th>이메일</th>
                        <td><input type="email" placeholder="abc@abc.com" name="email" required></td>
                    </tr>
                    <tr>
                        <th>사업자등록번호</th>
                        <td><input type="text" placeholder="(-없이)1234567890" name="businessNo" id="businessNo" maxlength="10" required></td>
                    </tr>
                </table>
